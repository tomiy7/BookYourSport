...
namespace AuthService.API.Migrations
{
    ...
    [Migration("20260823210826_AddUserApprovalRelatedStatuses")]
    partial class AddUserApprovalRelatedStatuses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuthService.API.Entities.User", b =>
                {
                    ...
                    b.ToTable("users", t =>
                        {
                            t.HasCheckConstraint("CK_Users_ApprovalStatus", "approval_status IN ('not_requested', 'pending', 'approved', 'rejected')");
